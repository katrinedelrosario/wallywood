import { FooterStyle } from "../styled/footer.style"
	  ...
	  <div>
		...
		<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 31 31">
			<g id="SoMe_Icon" data-name="SoMe Icon" transform="translate(1.5 1.5)">
				...
				<path id="Path_3" data-name="Path 3" d="M26.25,9.75h0" transform="translate(-1.55 -0.45)" fill="none" stroke="#ccc" stroke-inecap="round" strokeLinejoin="round" strokeWidth="3"/>
				</g>
			</g>
		</svg>
